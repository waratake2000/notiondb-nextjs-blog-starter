...
const CardsWrapper = () => {
  return (
    <SideMargin>
      <div className='w-full h-full grid grid-cols-3 gap-9'>
        <ArticleCard
        ...
        >
          【サンプル】サンプルタイトルサンプルタイトルサンプサンプルタイトルサンプ
        </ArticleCard>
        ...
        >
          【サンプル】サンプルタイトルサンプルタイトルサンプサンプルタイトルサン
        </ArticleCard>
        ...
        >
          【サンプル】サンプルタイトルサンプルタイトルサンプサンプルタイトルサンプルタイトルサ
        </ArticleCard>
